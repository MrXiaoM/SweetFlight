...
public enum Messages implements IHolderAccessor {
    ...
    command__check__locale_add("&e  %locale% &f+%time%"),
    command__check__locale_set("&e  %locale% &f=%time%"),
    command__check__locale_infinite("&e  %locale% &f无限时间"),
